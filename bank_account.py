class Account:
    ...
    def withdraw(self, amount):
        if self._balance - amount >= Account._minimum_balance:
            self._balance -= amount
            return True
        return False
    ...
    def __str__(self):
        return f"{self.__class__.__name__}({self._account_number}, {self._holder_name}, Balance: {self._balance})"
...
savings_account = SavingAccount("SA001", "Alice Johnson", 1000, 2.5)
...
try:
    invalid_account = SavingAccount("SA002", "", -100, 1.5)  # Should raise error
